 ...
 * Time: 20:19
 */
class Colaboradores_mapper extends CI_Model{

    private $_tableNme = null;

    public function __construct() {
        $this->_tableNme =  APPPATH . 'json_data/colaboradores.json';
    }
    ...
    public function save(Colaboradores_model $model){

        $data = array(
            'id' => time(),
            'name' => $model->getName(),
            'nameEmpresa' => $model->getNameEmpresa()
        );
